...
import { removeToken, getToken, refreshAccessToken } from "../lib/authService";
...
/**
 * Sign out by removing the stored tokens only.
 * (Do NOT clear PIN or biometric preference so they remain available.)
 */
export async function signOut(): Promise<void> {
  await removeToken(); // clears access/refresh + logged_in flag inside
  delete api.defaults.headers.common["Authorization"];
}
